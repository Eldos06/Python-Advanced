...
# class RegisterMeeta(type):
#   _registry = {}
#   def __new__(mcs, name, bases, attrs):
#     if name in mcs._registry:
#       raise NameError(f"Class {name} already exists in the registry.")
#     cls = super().__new__(mcs, name, bases, attrs)
#     mcs._registry[name] = cls
#     return cls


# class User(metaclass=RegisterMeeta):
#   pass

# class Post(metaclass=RegisterMeeta):
#   pass

# # print(RegisterMeeta._registry)  # Output
